    ...
    return (
      <BaseContainer>
        <div className="HighRollers-Div-Main">
          ...
          {this.state.currentGame.contractAddress ? (
            <div>
              <h3 className="HighRollers-Current-Game-Address-h3">
                Current Game: {this.state.currentGame.contractAddress}
              </h3>
              {this.state.currentGame.winner !==
              "0x0000000000000000000000000000000000000000" ? (
                <h3 className="HighRollers-Current-Game-Winner-Address-h3">
                  Winner: {this.state.currentGame.winner}
                </h3>
              ) : (
                <div>
                  <h3 className="HighRollers-Current-Game-Winner-Address-h3">
                  ...
                  <h6 className="CoinFlip-Waiting-h6">
              ...
              <h3 className="HighRollers-Current-Game-TimeLeft-h3">
                {" "}
                {this.state.minutesLeft} Minutes {this.state.secondsLeft}{" "}
                Seconds{" "}
              </h3>
            </div>
          ) : (
