...
import { BaseContainerContext } from "../utils/contexts";
const Home = () => {
  return (
    <BaseContainer>
      <HomePageContent />
  ...
  return (
    ...
    >
      <Box
        ...
        py="40px"
      >
        <Flex w="100%" h="100%" justify="center" py="20px">
          <div className="sign">
      ...
      >
        <VStack>
          ...
          <HStack>
            <Image borderRadius="20px" boxSize="100px" src={ape} alt="error" />
            <Image borderRadius="20px" boxSize="100px" src={dood} alt="error" />
            <Image borderRadius="20px" boxSize="100px" src={cat} alt="error" />
          </HStack>
