...
const RaffleDeposit = (props:Props) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (window.ethereum) {
            ...
            const raffleContract = await new ethers.Contract(props.raffleContractAddress, _Raffle_abi, signer);
    ...
    return (
        <div className="Deposit-Container-Main">
            ...
            <div className="Deposit-PopUp-Form">
                <h3 className="Deposit-To-Win-h3">Deposit to win {props.tokenMetaData.tokenName} #{props.tokenMetaData.tokenID}!</h3>
